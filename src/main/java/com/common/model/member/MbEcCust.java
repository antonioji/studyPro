 ...
 */
@Data
public class MbEcCust implements Serializable {

	private static final long serialVersionUID = 235989121703906002L;
	...
	private String successYn = "Y";//에러 발생시 N으로 들어오는 필드 기본 Y
	private String result;//중복 결과 A:이름 ,이메일 , 휴대폰번호가 중복, B : 이름 , 이메일만 중복 , C : 이름 , 휴대폰만 중복  , D : 이름 , 이메일,  휴대폰 번호가 일치인 인증대기 상태, N : 중복안됨

	private String maskEmailAddr;
}
